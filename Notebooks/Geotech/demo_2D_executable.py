...
from demo_geotech_breakwater2D_executable import calculate_stability
...
def breakwater_design():
    ...
    battjes = bw.BattjesGroenendijk(
        Hm0=Hm0, h=(h + DHWL), slope_foreshore=slope_foreshore
    )
    ...
    Grading_EI = {
        ...
        "10-13t": {
            "M50": [M50_emll_10_13t, M50_umul_10_13t],
            "NLL": 10000,
            "NUL": 13000,
        },
    }
    ...
    lc_300 = pd.read_csv(
        r"C:\Users\QPQ\Python\Projects\breakwater\Notebooks\Excel_Files/Liebherr300t.csv"
    )
    ...
    lc_700 = pd.read_csv(
        r"C:\Users\QPQ\Python\Projects\breakwater\Notebooks\Excel_Files/Liebherr700t.csv"
    )
    ...
    if optimize:
        ...
        for opt in optimizations:
            ...
            configs = calculate_stability(configs, 0.8)
    ...
    # configs = bw.design_2D.read_breakwaters(
    #     r"C:\Users\QPQ\Python\Projects\breakwater\Notebooks\Geotech\results\opt.breakwaters"
    # )
