...
def breakwater_design():
    ...
    platefeeder = bw.PlateFeeder(name = 'platefeeder',
                                layer_cost = {'0-200mm': {'cost': 69, 'CO2': None, 'production_rate': 18332.86},
    ...
    dumptruck = bw.Truck(name = 'dumptruck',
                        layer_cost = {'0-300mm': {'cost': 16, 'CO2': None, 'production_rate':  15713.88},
    ...
    CP385 = bw.Excavator(
        ...
        layer_cost = {'60-300kg': {'cost': 39, 'CO2': None, 'production_rate': 14761.90},
    ...
    Hit1900 = bw.HITACHI_EX1900(name = 'Hit1900',
                                layer_cost = {'1-3t': {'cost': 56, 'CO2': None, 'production_rate':  6963.16},
    ...
    lc_300 = pd.read_csv(r'C:\Users\QPQ\Python\Projects\breakwater\Notebooks\Excel_Files/Liebherr300t.csv')
    lc_300 = lc_300.set_index('Radius')

    Liebherr300 = bw.Crane(name= 'Liebherr300',
                        layer_cost= {'11.67': {'cost': 174, 'CO2': None, 'production_rate': 4110.17},
    ...
    lc_700 = pd.read_csv(r'C:\Users\QPQ\Python\Projects\breakwater\Notebooks\Excel_Files/Liebherr700t.csv')
    lc_700 = lc_700.set_index('Radius')

    Liebherr700 = bw.Crane(name= 'Liebherr700',
                        layer_cost= {'11.67': {'cost': 204, 'CO2': None, 'production_rate': 3110.17},
    ...
    SSD_res = bw.Vessel(name = 'SSD_resolution',
                        layer_cost = {'0-200mm': {'cost': 59, 'CO2': None, 'production_rate': 14928.19},
    ...
    SSD_HAM = bw.Vessel(name = 'SSD_HAM602',
                        layer_cost = {'QR 1-1000kg': {'cost': 100, 'CO2': None, 'production_rate': 1889.70},
    ...
    configs = bw.design_2D.read_breakwaters(r'C:\Users\QPQ\Python\Projects\breakwater\Notebooks\Geotech\results\opt.breakwaters')
